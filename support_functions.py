...
def print_instruction_color():
    print(Fore.CYAN + "="*60)
    print(Fore.CYAN + "Обработчик Отчета по проводкам 1С".center(60))
    ...
    print("    - Заголовки столбцов: |Дата|Документ|Содержание|\n")
    ...
    print(Style.RESET_ALL + " - Время обработки объемных регистров может быть увеличено (500 тыс. строк ~ 2 мин)).\n")
